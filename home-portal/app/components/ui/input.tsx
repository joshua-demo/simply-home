  ...
  return (
    <div className="w-full flex flex-row">
      <textarea
        ...
        className={"p-4 w-full text-center bg-transparent focus:outline-none text-2xl resize-none overflow-scroll min-h-[30vh] max-h-[50vh] lg:min-h-[10vh] lg:max-h-[55vh]"}
